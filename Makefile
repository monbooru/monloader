...
LDFLAGS  := -ldflags="-X 'github.com/monbooru/monloader/internal/web.Version=$(VERSION)' -X 'github.com/monbooru/monloader/internal/web.RepoURL=$(REPO_URL)' -X 'github.com/monbooru/monloader/internal/web.DocURL=$(DOC_URL)'"
